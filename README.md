...
This repo is a simple Rails project that providing messages as API for the react front end project [Hello React Front End App](https://github.com/ridabensalem/react_front_end).
...
```sh
  cd react_front_end
  git@github.com:ridabensalem/react_front_end.git
```
